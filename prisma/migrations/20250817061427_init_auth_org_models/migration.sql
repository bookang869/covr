...
CREATE TABLE "public"."Vendor" (
    ...
    "dataSensitivity" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "idx_vendor_org" ON "public"."Vendor"("orgId");
...
-- AddForeignKey
ALTER TABLE "public"."Vendor" ADD CONSTRAINT "Vendor_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "public"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Vendor" ADD CONSTRAINT "Vendor_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
